      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="grid md:grid-cols-12 gap-16 items-start">
          <div className="md:col-span-7">
            ...
            >
              <h2 className="text-[10px] uppercase tracking-[0.4em] mb-8 font-semibold text-[#1A1A1A]/50">Die Herausforderung</h2>
              <h3 className="text-[40px] md:text-[60px] leading-[0.9] font-black uppercase tracking-tighter mb-8">
                Warum bis zu <span className="font-serif italic font-normal tracking-normal text-[#1A1A1A]/40">70% aller Leads</span> nie kontaktiert werden.
              </h3>
              ...
              <div className="space-y-12 border-t border-[#1A1A1A]/10 pt-12">
                <div className="flex gap-8">
                  <div className="text-[32px] font-serif italic leading-none text-[#1A1A1A]/30">01.</div>
                  <div>
                ...
                <div className="flex gap-8">
                  <div className="text-[32px] font-serif italic leading-none text-[#1A1A1A]/30">02.</div>
                  <div>
                ...
                <div className="flex gap-8">
                  <div className="text-[32px] font-serif italic leading-none text-[#1A1A1A]/30">03.</div>
                  <div>
          ...
          <div className="md:col-span-5 md:pl-10 md:border-l border-[#1A1A1A]/10 h-full">
            ...
            >
              <div>
                <div className="mb-10">
                  <h3 className="text-2xl font-serif italic mb-4">Die Lösung.</h3>
              ...
              <div className="pt-10 border-t border-[#1A1A1A]/10">
                <div className="text-[64px] font-black tracking-tighter leading-none">100%</div>
